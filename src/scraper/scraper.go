// Package scraper implements a web scraper to retrieve events from the RHUL students' union events' calendar.
// uses Colly library for scraping, json file for caching and stops users from spamming the dest server.
package scraper
...
func ScrapeEvents(numEvents int) ([]Event, error) {
	...
	c.OnError(func(r *colly.Response, err error) {
		...
		// TODO: add normal print or show to user if error occurs
	})
...
func ShouldScrape() bool {
	...
	// TODO: feat: later, maybe user can specify a soft time limit in settings
